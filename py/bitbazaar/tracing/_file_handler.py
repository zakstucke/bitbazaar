...
from ._formatting import file_log_formatter, file_span_formatter
...
class CustomRotatingFileHandler(RotatingFileHandler):
    ...
    def emit(self, record: LogRecord | ReadableSpan) -> None:
